    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
                ('survey_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='socialnetwork.surveyquestion')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
        ...
        migrations.AddField(
            ...
            name='survey_post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='socialnetwork.surveypost'),
        ),
        migrations.CreateModel(
            name='Reaction',
            fields=[
